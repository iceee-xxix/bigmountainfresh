...
Route::middleware('checkAdmin')->group(function () {
    ...
    Route::prefix('/admin/work_leave')->group(function () {
        ...
        Route::post('/delete', [workleaveController::class, 'work_leave_cancel'])->name('work_leave_cancel');
        Route::post('/approve', [workleaveController::class, 'work_leave_approve'])->name('work_leave_approve');
    });
