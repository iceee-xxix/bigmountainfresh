...
@section('dashbord_layout')
    ...
    <div class="container mt-3 ">
        ...
        <div class="text-center" id="currentDateTime" style="margin-top: 40px; font-size: 25px;"></div>
        ...
        <div class="card mb-4 mt-4 col-md-8 mx-auto">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <p>ประเภท :
                                @if ($attemp_histories->attemp_type == 2)
                                    นอกหน่วยงาน
                                @elseif($attemp_histories->attemp_type == 3)
                                    ราชการ
                                @endif
                            </p>
                            <p>หมายเหตุ : {{ $attemp_histories->attemp_describe }}</p>
                            <p>ภาพประกอบ :</p>
