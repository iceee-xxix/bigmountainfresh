            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <?php if ($worktime->attemp_describe) {
                            echo $worktime->attemp_describe;
                        } else {
                            if ($worktime->attemp_late_time) {
                                echo 'มาสาย ' . $worktime->attemp_late_time . ' นาที';
                            } else {
                                echo $worktime->InOutStatus;
                            }
                        } ?>
                    </td>
                    <th>
...
@foreach ($worktimes as $worktime)
<div class="modal fade" id="{{ 'editModal_' . $worktime->id }}" data-bs-backdrop="static"
